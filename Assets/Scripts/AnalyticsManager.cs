...
namespace StudioByStorm {
    ...
    public class AnalyticsManager : MonoBehaviour
    {
        ...
        {
            if (isDebugging) Debug.Log("Status: " + status.ToString() + " Chapter: " + chapter.ToString()  + " Level: " + level.ToString());
        ...
        {
            if (isDebugging) Debug.Log("Status: " + status.ToString() + " Chapter: " + chapter.ToString()  + " Level: " + level.ToString()  + " Score: " + score.ToString());
