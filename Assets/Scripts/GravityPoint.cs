...
public class GravityPoint : MonoBehaviour
{
    ...
    public GameObject planet, surface, minRS, maxRS;
    ...
    void Update()
    {
        ...
        //collider.radius = planetRadius + gravityMinRange + gravityMaxRange;
    ...
    void OnTriggerStay2D(Collider2D obj)
    {
        ...
        Vector3 dir = (transform.position - obj.transform.position) * Mathf.Abs(gravitationalPower);
